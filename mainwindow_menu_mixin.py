...
class MainWindowMenuMixin:
    def _build_menu(self) -> None:
        ...
        # Sequencer remains intentionally hidden while deferred for refinement.
        playlists_action = QAction("Playlists", self)
        playlists_action.triggered.connect(self._on_tools_open_playlists)
        ...
        help_menu.addAction(audio_diagnostics_action)
