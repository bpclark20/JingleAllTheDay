...
class MainWindowMenuMixin:
    def _build_menu(self) -> None:
        ...
        record_jingle_action.triggered.connect(self._on_record_jingle)
        tools_menu.addAction(record_jingle_action)
        open_sequencer_action = QAction("Open Sequencer", self)
        open_sequencer_action.triggered.connect(self._on_open_sequencer)
        tools_menu.addAction(open_sequencer_action)
        open_mixer_action = QAction("Open Mixer...", self)
        open_mixer_action.triggered.connect(self._on_open_mixer_switcher)
        tools_menu.addAction(open_mixer_action)
